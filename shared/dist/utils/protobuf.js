...
let root = null;
export async function loadProtobufRoot() {
    if (!root) {
...
export async function encodeTradingOpportunity(opportunity) {
...
export async function decodeTradingOpportunity(data) {
    const root = await loadProtobufRoot();
    const TradingOpportunityMessage = root.lookupType('TradingOpportunity');
...
export async function encodeBinaryRPCMessage(messageType, requestId, payload) {
    const root = await loadProtobufRoot();
...
export async function decodeBinaryRPCMessage(data) {
    const root = await loadProtobufRoot();
    const BinaryRPCMessage = root.lookupType('BinaryRPCMessage');
